...
import { TestingDataService } from '../../../shared/services/testing-data.service';
...
export class TestPageComponent implements OnInit {
  ...
  finish() {
    ...
    this.test.date = currentDate;
    clearInterval(this.timer);
    // this.testingDataService.sendTestResult(this.test, currentDate).subscribe((res:Tests) => {
    //   this.result = res;
